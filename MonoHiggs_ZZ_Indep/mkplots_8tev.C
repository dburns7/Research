...
int mkplots_8tev(){
   ...
   hmet_sig12->SetAxisRange(75., 250.,"X");
   ...
   leg5->Draw();
   TLine *l5 = new TLine(105, 0, 105, 0.25);
   l5->SetLineWidth(3);
   l5->Draw();
   TLine *l6 = new TLine(145, 0, 145, 0.25);
   l6->SetLineWidth(3);
   l6->Draw();
   c5->SaveAs("mllll.png");
   ...
   leg6->Draw();
   TLine *l7 = new TLine(75, 0, 75, 0.04);
   l7->SetLineWidth(3);
   l7->Draw();
