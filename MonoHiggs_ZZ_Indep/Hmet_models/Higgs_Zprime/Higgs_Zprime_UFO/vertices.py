...
V_54 = Vertex(name = 'V_54',
              particles = [ P.chi__tilde__, P.chi, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
...
V_91 = Vertex(name = 'V_91',
              ...
              couplings = {(0,0):C.GC_76,(0,1):C.GC_84})
...
V_94 = Vertex(name = 'V_94',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV2, L.FFV3 ],
              couplings = {(0,0):C.GC_82,(0,1):C.GC_86})

V_95 = Vertex(name = 'V_95',
              particles = [ P.s__tilde__, P.s, P.Zp ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV2, L.FFV3 ],
              couplings = {(0,1):C.GC_86,(0,0):C.GC_82})
...
V_124 = Vertex(name = 'V_124',
               ...
               couplings = {(0,0):C.GC_76,(0,1):C.GC_85})
...
V_127 = Vertex(name = 'V_127',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV4 ],
               couplings = {(0,0):C.GC_82,(0,1):C.GC_87})
...
V_166 = Vertex(name = 'V_166',
               ...
               couplings = {(0,0):C.GC_77,(0,1):C.GC_84})
